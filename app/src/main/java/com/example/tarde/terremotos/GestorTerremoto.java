...
public class GestorTerremoto extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
       ...
       Terremoto item = (Terremoto) parent.getItemAtPosition(position);
